        ...
        <div class="items-center">
          ...
          <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-lg text-gray-600 mb-8">
              {{ contactInfo.availability }}. Whether you have a project in mind, want to collaborate, 
            ...
            <div class="space-y-6 mb-12">
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <a :href="`mailto:${contactInfo.email}`" class="text-lg text-gray-900 hover:text-blue-600 transition-colors">
                    {{ contactInfo.email }}
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <a :href="`tel:${contactInfo.phone}`" class="text-lg text-gray-900 hover:text-blue-600 transition-colors">
                    {{ contactInfo.phone }}
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div>
                  ...
                  <p class="text-lg text-gray-900">{{ contactInfo.address }}</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex space-x-4">
                ...
                >
                  <img :src="getSocialIconUrl(social.icon)" class="w-6 h-6 hover:scale-150 transition-all duration-300 group-hover:text-white" />
                </a>
              </div>
            </div>
          </div>
...
// const contactInfo = useDummyContact()
const { data: contactInfo } = await useContact()
